...
LLVMTypeKind LLVMGetTypeKind(LLVMTypeRef Ty) {
  ...
  case Type::RISCV_THEADMRTyID:
    return LLVMRISCV_THEADMRTypeKind;
  case Type::TokenTyID:
...
LLVMTypeRef LLVMRISCVTHEADMRTypeInContext(LLVMContextRef C) {
  return (LLVMTypeRef) Type::getRISCV_THEADMRTy(*unwrap(C));
}
...
LLVMTypeRef LLVMRISCVTHEADMRType(void) {
  return LLVMRISCVTHEADMRTypeInContext(LLVMGetGlobalContext());
}
