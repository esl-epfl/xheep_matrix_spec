...
public:
  ...
  enum TypeID {
    ...
    RISCV_THEADMRTyID, ///<T-HEAD riscv matrix extension 2048 bits
    TokenTyID,     ///< Tokens
...
public:
  ...
  /// Return true if this is RISCV THEADMR.
  bool isRISCV_THEADMRTy() const { return getTypeID() == RISCV_THEADMRTyID; }
  ...
  static Type *getRISCV_THEADMRTy(LLVMContext &C);
